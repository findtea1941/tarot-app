...
type FourElementsEntryBoardProps = {
  layout: SpreadLayout;
...
export function FourElementsEntryBoard({
  layout,
  slotInputs,
  onSlotInputChange,
  slotErrors = {},
}: FourElementsEntryBoardProps) {
  ...
  return (
    <div className="relative mx-auto w-full max-w-5xl px-2" style={{ aspectRatio: "2.3" }}>
